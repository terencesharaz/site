function replaceEmbedToImage(embedType) {
    ...
    var embed = document.querySelectorAll('.' + className),
        ...
        settings_thumb_extension = 'jpg';

    var settings_thumb_base_url = (embedType == 'youtube') ? 'https://img.youtube.com/vi/' : 'https://raw.githubusercontent.com/the-muda-organization/vimeo-lazyload/master/demo-img/';
    if (embed.length > 0) {
        ...
        var allow = (embedType == 'youtube') ? 'accelerometer;autoplay;encrypted-media;gyroscope;picture-in-picture' : 'autoplay;fullscreen';
        ...
        embed_observer = new IntersectionObserver(function (elements) {
            elements.forEach(function (e) {
                ...
                if (e.isIntersecting === true) {
                    ...
                    var urlValue = (embedType == 'youtube') ? settings_thumb_base_url + this_data_id + this_data_thumb + '/hqdefault.' + settings_thumb_extension : settings_thumb_base_url + this_data_id + this_data_thumb + '.' + settings_thumb_extension;
